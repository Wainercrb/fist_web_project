...
<div class="row">
    ...
    <h1>¡Tipos de usuarios¡<br></h1>
    
    <p id="main-para">Existen diferentes tipos de usuarios que la esta aplicación web puede albergar, esto para cumplir con la función de intermediario entre cliente y vendedor, los siguientes son los dos tipos de usuarios válidos.
    </p>
    <li id="main-para">Cliente: </li>
    <p id="main-para">Este usuario podrá tener una cuenta con la cual podrá realizar actividades como: ver los perfiles de las demás, comprar, editar su propio perfil, pero no podrá subir o vender un artículo.</p>
    <li id="main-para">Vendedor:</li>
    <p id="main-para">Este usuario podrá ver los demás perfiles, no podrá comprar, pero si podrá editar su propio perfil, con la opción de poder publicar objetos a vender.</p>
</div>
...
<script type="text/javascript" src="js/tiposPerfil.js"></script>
</body>
</html>