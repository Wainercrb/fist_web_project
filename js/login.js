...
/*Funcion ingresa al login que se encuentra en el cuerpo de html*/
function bodyLogin() {
  Usuarios = [];
  cargarUsuarios();
...
/*funcion verifica si hay un usaurio en el session Storange y si hay, carga sus datos a interfaz*/
