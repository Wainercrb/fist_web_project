...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Restablecer contrasenña</title>
        ...
        <link rel="stylesheet" type="text/css" href="css/cambioContrasena.css">
    </head>
    <body>
        <div id="top">
            <div class="container">
    ...
    <form class="navbar-form navbar-left" role="search" height="10px">
        <div class="form-group div-search ">
            <div class="input-group input-group-lg input-group-full search">
                <input type="text" class="form-control" id="btn-search"  value = "" aria-label="Search" size="100">
...
<div class="main-login" id="conte">
    ...
    <div class="form-group center-block" id="midiv">
        <div class="group center-block">
            <input type="text" required id="txtUsuarioEmail"/>
    ...
    <div class="form-group" id="divContrasena1">
        <div class="group">
            <input type="password" required id="txt-contrasena1"/>
            <span class="highlight"></span>
            <!--label-->
            <span class="bar"></span>
            <!--botton del input-->
    ...
    <div class="form-group">
        <div class="group">
            <input type="password" required id="txt-contrasena2"/>
            <span class="highlight"></span>
            <!--label-->
            <span class="bar"></span>
            <!--botton del input-->
            <label class=label-login>Verificación</label>
        </div>
    </div>
</div>
<div class="form-group">
...
<script type="text/javascript" src="js/cambioContrasena.js"></script>
</body>
</html>