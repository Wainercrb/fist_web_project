    ...
    <form role="form">
        <div class="form-group">
            <div class="text-center">
                <img src="img/user.png" class="img-circle" id="fotoUsuario" onmouseover="this.width=70;this.height=70;" onmouseout="this.width=64;this.height=64;" width="64" height="64">
            </div>
            ...
            <div class="alert alert-success class midiv">
                <span class="label label-primary">Usuario
                </span>
                <p id="usuarioUsuario"></p>
            </div>
            <div class="alert alert-success class midiv">
                <span class="label label-primary">Contraseña</span>
                
                <span class="glyphicon glyphicon-eye-open" id="eye"></span>
                <input id="contrasenaUsuario" type="password" class="transparent-input"></input>
            </div>
            <div id="mapMain">
                <div id="map"></div>
