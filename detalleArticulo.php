...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/detallesArticulo.css">
    </head>
    <body>
        <div id="top">
            <div class="container">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-lg-12 second-div text-center">
                                    ...
                                    <form class="form" role="form" method="post" action="login" accept-charset="UTF-8" id="login-nav">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="help-block text-center"><a href="">Olvido su contraseña?</a></div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="bottom text-center">
                                    ¿No sabes como que usuario registrar? <a href="#"><b>ver</b></a>
                                </div>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="wrapper row">
                <div class="preview col-md-6">
                    <div class="preview-pic tab-content">
                        <div class="tab-pane" id="pic-1"><img src="https://www.tventas.com/img/p/3/0/4/9/5/30495-thickbox_default.jpg" /></div>
                        <div class="tab-pane" id="pic-2"><img src="https://f4.bcbits.com/img/a0372139383_10.jpg" /></div>
                        <div class="tab-pane" id="pic-3"><img src="http://img.webdelamoda.com.s3.amazonaws.com/wp-content/uploads/2017/05/look-terciopelo04-150x150.jpg"/></div>
                        <div class="tab-pane" id="pic-4"><img src="http://img.webdelamoda.com.s3.amazonaws.com/wp-content/uploads/2015/04/blu-gr.jpg"></div>
                        <div class="tab-pane" id="pic-5"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoWPtBsj1MTXos50wxd5xKvzG3CX3xNc0CXTwx6L4jkgcT4-tM"/></div>
                    </div>
                    <ul class="preview-thumbnail nav nav-tabs">
                        <li>
                            <a data-target="#pic-1" data-toggle="tab"><img src="https://www.tventas.com/img/p/3/0/4/9/5/30495-thickbox_default.jpg" class="second-img"/></a>
                        </li>
                        <li>
                            <a data-target="#pic-2" data-toggle="tab"><img src="https://f4.bcbits.com/img/a0372139383_10.jpg" class="second-img"/></a>
                        </li>
                        <li>
                            <a data-target="#pic-3" data-toggle="tab"><img src="http://img.webdelamoda.com.s3.amazonaws.com/wp-content/uploads/2017/05/look-terciopelo04-150x150.jpg" class="second-img"/></a>
                        </li>
                        <li>
                            <a data-target="#pic-4" data-toggle="tab"><img src="http://img.webdelamoda.com.s3.amazonaws.com/wp-content/uploads/2015/04/blu-gr.jpg" class="second-img"/></a>
                        </li>
                        <li>
                            <a data-target="#pic-5" data-toggle="tab"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRoWPtBsj1MTXos50wxd5xKvzG3CX3xNc0CXTwx6L4jkgcT4-tM" class="second-img"/></a>
                        </li>
                    </ul>
                </div>
                <div class="details col-md-6">
                    <h3 class="product-title" id="hNombreProducto">Nombre del producto</h3>
                    <p class="product-description" id="pDescripcion">Descripción.</p>
                    <h4 class="price">Precio: <span id="sPrecio">₡20,000,00</span></h4>
                    <h5 class="sizes">Tallas:
                    ...
                    <div class="action" id="div-btn-comprar">
                        <div class="action">
                            <label for="acciones">Acciones para comprar</label>
                        </div>
                        <div class="form-group" id="select-category-form">
                            <span id="select-cb">Talla</span>
                            <span class="select-group-button">
                                <select  id="radius" class="form-control" type="select">
                                    <option id="option-select" value="">X</option>
                                    <option id="option-select" value="">S</option>
                                    <option id="option-select" value="">XS</option>
                                    <option id="option-select" value="">XL</option>
                                    <option id="option-select" value="">M</option>
                                    <option id="option-select" value="">MS</option>
                                </select>
                            </span>
                        </div>
                        <div id="select-category-form">
                            <span id="select-cb">Color</span>
                            <span class="select-group-button">
                                <select  id="radius" class="form-control" type="select">
                                    <option id="option-select" value="">rojo</option>
                                    <option id="option-select" value="">Azul</option>
                                    <option id="option-select" value="">Amarillo</option>
                                </select>
                            </span>
                        </div>
