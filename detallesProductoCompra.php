...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="css/BuscarArticulo.css">
...
<body>
    ...
    <div class="container" id="container">
             <div class="col-md-12"> 
               <h1 id="hResultado"></h1>          
                <div class="row" id="appendConteint">
    ...
    <script type="text/javascript" src="js/BuscarArticulos.js"></script>
</body>
</html>
